...
var UpdateUserAvatarService = /** @class */ (function () {
    ...
    UpdateUserAvatarService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, user, useAvatarFilePath, userAvatarFileExists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        useAvatarFilePath = path_1.default.join(upload_1.default.directory, user.avatar);
                        return [4 /*yield*/, fs_1.default.promises.stat(useAvatarFilePath)];
                    case 2:
                        userAvatarFileExists = _b.sent();
                        if (!userAvatarFileExists) return [3 /*break*/, 4];
                        return [4 /*yield*/, fs_1.default.promises.unlink(useAvatarFilePath)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
